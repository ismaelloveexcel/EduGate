...
echo ""
echo "==> Move these issues to 'Ready' immediately (by title):"
echo "    - Scaffold monorepo folders + Flutter app"
echo "    - Add GitHub Actions Flutter CI (analyze + test)"
echo "    - Add baseline dependencies + app config (Riverpod + GoRouter)"
echo "    - Firebase project setup (dev)"
echo "    - FlutterFire configure + firebase_options integrated"
echo "    - Parent signup/login/logout (Email/Password)"
echo "    - Parent profile document creation in Firestore"
echo "    - Child profiles CRUD (create/edit/archive)"
echo "    - Child PIN setup + secure validation"
echo "    - Child selector screen (siblings switch)"
echo "    - Child PIN screen (gates child access)"
