...
- **Flutter analyze has pre-existing errors**: The codebase has ~26 analysis errors (e.g., `valueOrNull` undefined on `AsyncValue<User?>`, deprecated `StateProvider` usage). These are pre-existing and do not affect unit tests.
